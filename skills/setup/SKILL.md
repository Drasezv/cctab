...
paste it. Run `setup.py <token>`: it checks the token against Telegram, warns
if a webhook would swallow our updates, and prints a link, plus a QR code when the qrcode library happens to be installed.
